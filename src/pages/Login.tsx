    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {mode === "login" ? "Sign in to your account" : "Start hauling or get your stuff delivered"}
          </CardDescription>
        </CardHeader>
            ...
            {mode === "signup" && (
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Your name" className="pl-9" value={fullName} onChange={(e) => setFullName(e.target.value)} required />
                </div>
              </div>
            )}
            <div className="space-y-2">
